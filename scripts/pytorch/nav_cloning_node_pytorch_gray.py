...
class nav_cloning_node:
    ...
    def loop(self):
        ...
        # if self.episode == 1:
        #     cv2.imwrite("/home/yuzuki/research/0.1_1.0_gray_scale_img/1.0.png", gray_img)
        #     cv2.imwrite("/home/yuzuki/research/0.1_1.0_rgb_img/1.0.png", self.cv_image)

        if self.episode == 1700:
            self.learning = False
            self.dl.save(self.save_path)
            # self.dl.load("/home/yuzuki/catkin_ws/src/nav_cloning/data/model_change_dataset_balance/20230505_23:16:45/model_gpu.pt")
        ...
        cv2.imshow("Gray Image", temp)
        temp = copy.deepcopy(self.cv_image)
        cv2.imshow("RGB Image", temp)
