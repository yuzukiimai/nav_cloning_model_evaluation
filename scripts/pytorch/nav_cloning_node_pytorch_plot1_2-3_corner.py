...
class nav_cloning_node:
    ...
    def loop(self):
        ...
        if self.learning:
            ...
            if self.ok_count_0 * 3 > self.count_0:
                self.flg_0 = True
            if self.ok_count_0 * 3 < self.count_0:
                self.flg_0 = False
            
            if self.ok_count_1 * 3 > self.count_1:
                self.flg_1 = True
            if self.ok_count_1 * 3 < self.count_1:
                self.flg_1 = False

            if self.ok_count_2 * 3 > self.count_2:
                self.flg_2 = True
            if self.ok_count_2 * 3 < self.count_2:
                self.flg_2 = False

            if self.ok_count_3 * 3 > self.count_3:
                self.flg_3 = True
            if self.ok_count_3 * 3 < self.count_3:
                self.flg_3 = False

            if self.ok_count_4 * 3 > self.count_4:
                self.flg_4 = True
            if self.ok_count_4 * 3 < self.count_4:
                self.flg_4 = False

            if self.ok_count_5 * 3 > self.count_5:
                self.flg_5 = True
            if self.ok_count_5 * 3 < self.count_5:
                self.flg_5 = False

            if self.ok_count_6 * 3 > self.count_6:
                self.flg_6 = True
            if self.ok_count_6 * 3 < self.count_6:
                self.flg_6 = False

            if self.ok_count_7 * 3 > self.count_7:
                self.flg_7 = True
            if self.ok_count_7 * 3 < self.count_7:
                self.flg_7 = False

            if self.ok_count_8 * 3 > self.count_8:
                self.flg_8 = True
            if self.ok_count_8 * 3 < self.count_8:
                self.flg_8 = False

            if self.ok_count_9 * 3 > self.count_9:
                self.flg_9 = True
            if self.ok_count_9 * 3 < self.count_9:
                self.flg_9 = False

            if self.ok_count_10 * 3 > self.count_10:
                self.flg_10 = True
            if self.ok_count_10 * 3 < self.count_10:
                self.flg_10 = False
