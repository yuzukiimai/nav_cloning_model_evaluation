...
class nav_cloning_node2:
    def __init__(self):
        ...
        self.image = Image.open(('/home/yuzuki/catkin_ws/src/nav_cloning')+'/maps/2_3_result.png').convert("L")
        self.arr = np.asarray(self.image)
        self.map_plot = self.ax.imshow(self.arr, cmap='gray', extent=[-15,11,-11,37.2])
        self.patches = [] 
    ...
    def update(self, frame):
        ...
        if self.trigger:
            self.ax.text(24, 0, "Test", color="c", fontsize="xx-large")
        
        else:
            self.ax.text(24, 0, "Train", color="m", fontsize="xx-large")
