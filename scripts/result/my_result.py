...
# for filename in sorted(glob.glob('/home/yuzuki//*/training_all.csv'), key=lambda f: os.stat(f).st_mtime, reverse=True):
...
def draw_training_pos_willow():
    ...
    while index < 100:
        ...
        # plt.savefig("/home/yuzuki/Pictures/33_(2)" + "/" + str(file_number) + ".png") 
        plt.pause(1)
        plt.close()
